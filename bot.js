...
const botOptions = {
    host: 'שם_השרת_שלך.aternos.me', // <--- כאן שמים את ה-IP של השרת באטרנוס
    port: 25565,                     // פורט ברירת מחדל (השאר 25565 אלא אם יש לך פורט דינמי)
    username: 'AntiAFK_Bot',         // השם של הבוט בתוך המשחק
    version: '1.20.1'                // <--- שנה לגרסה המדויקת של השרת שלך (למשל 1.21, 1.20.4 וכו')
};
